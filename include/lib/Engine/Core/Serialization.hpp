...
namespace YAML
{
	...
	template <> struct convert<glm::dvec2>
	{
	...
	template <> struct convert<glm::dvec3>
	{
	...
	template <> struct convert<glm::dvec4>
	{
	...
	template <> struct convert<glm::uvec3>
	{
	...
	template <> struct convert<glm::uvec4>
	{
	...
	template <> struct convert<glm::i8vec4>
	{
	...
	template <> struct convert<glm::i16vec4>
	{
	...
	template <> struct convert<glm::u16vec4>
	{
