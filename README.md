# EvoEngine
EvoEngine is an early-stage, cross-platform interactive application and rendering engine for Windows and Linux (MacOS I'm truly sorry, but nah). 
## Main features
Here lists the features that already exists in the EvoEngine.
 ...
 - Exportable as shared library (For my own research purposes, I'm using the EvoEngine as the underlying rendering framework for my other research projects. Those are private.)
...
## Upcoming features
Here lists the features that will be introduced to EvoEngine in future, though I don't have a concrete plan of when these will come.
