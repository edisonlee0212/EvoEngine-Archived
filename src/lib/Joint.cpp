...
void Joint::OnInspect(const std::shared_ptr<EditorLayer>& editorLayer)
{
    static int type = 0;
    ...
    editorLayer->DragAndDropButton<RigidBody>(m_rigidBody1, "Link 1");
    editorLayer->DragAndDropButton<RigidBody>(m_rigidBody2, "Link 2");
