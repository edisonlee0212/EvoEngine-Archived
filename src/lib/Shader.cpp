	...
	case ShaderType::Vertex:
		{
			...
			fragShaderCreateInfo.stage = VK_SHADER_STAGE_VERTEX_BIT;
		} break;
	case ShaderType::TessellationControl:
		{
			shaderKind = shaderc_tess_control_shader;
			fragShaderCreateInfo.stage = VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT;
		} break;
	case ShaderType::TessellationEvaluation:
		{
			shaderKind = shaderc_tess_evaluation_shader;
			fragShaderCreateInfo.stage = VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT;
		} break;
	case ShaderType::Geometry:
		{
			shaderKind = shaderc_geometry_shader;
			fragShaderCreateInfo.stage = VK_SHADER_STAGE_GEOMETRY_BIT;
		} break;
	...
	case ShaderType::Compute:
		{
			...
			fragShaderCreateInfo.stage = VK_SHADER_STAGE_COMPUTE_BIT;
		} break;
	case ShaderType::Unknown:
		{
			shaderKind = shaderc_glsl_infer_from_source;
			fragShaderCreateInfo.stage = VK_SHADER_STAGE_ALL_GRAPHICS;
		} break;
