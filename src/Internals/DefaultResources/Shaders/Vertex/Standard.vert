...
void main()
{
	...
	vec3 N = normalize(vec3(EE_INSTANCES[EE_INSTANCE_INDEX].model * vec4(inNormal,    0.0)));
	vec3 T = normalize(vec3(EE_INSTANCES[EE_INSTANCE_INDEX].model * vec4(inTangent,   0.0)));
