...
uniform sampler2DArray EE_DIRECTIONAL_LIGHT_SM;
uniform sampler2DArray EE_POINT_LIGHT_SM;
uniform sampler2D EE_SPOT_LIGHT_SM;

uniform sampler2D EE_ALBEDO_MAP;
uniform sampler2D EE_NORMAL_MAP;
uniform sampler2D EE_METALLIC_MAP;
uniform sampler2D EE_ROUGHNESS_MAP;
uniform sampler2D EE_AO_MAP;

uniform samplerCube EE_SKYBOX;
uniform samplerCube EE_ENVIRONMENTAL_IRRADIANCE;
uniform samplerCube EE_ENVIRONMENTAL_PREFILERED;
uniform sampler2D EE_ENVIRONMENTAL_BRDFLUT;
